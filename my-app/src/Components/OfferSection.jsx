...
const OfferSection = () => {
    ...
    const stepText = isSmallScreen ? '' : 'Step';
            ...
            <div>
                ...
                <div className={styles.steps}>
                    <span className={styles.hexaSection}>
                        <div className={styles.hexagone}><p>{stepText} 1</p></div>
                        <span className={styles.divider}></span>
                        <div className={styles.hexagone}><p>{stepText} 2</p></div>
                        <span className={styles.divider}></span>
                        <div className={styles.hexagone}><p>{stepText} 3</p></div>
                    </span>
                    <span className={styles.main_div1}>
                        <div className={styles.div3}>
                            <h3>{stepText} 1 : Enroll into your favorite course for only ₹1,499</h3>
                            <img src={img1} alt='img'></img>
                            <p>Start Learning with <strong> Lifetime Course Access.</strong></p>
                        </div>
                        <div className={styles.div3}>
                            <h3>{stepText} 2: Complete Course & Assignments within 2 Years!</h3>
                        ...
                        <div className={styles.div3}>
                            <h3>{stepText} 3: Receive 100% Refund upon completion</h3>
                            <span className={styles.div3_sub_span1}>
                                <h1>3</h1>
                                <p>
